...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
   ...
   <!-- ICON GO TO -->
    <link rel="shortcut icon" href="img/Belo Destino3.png" type="image/x-icon">
    ...
    <title> Login -Belo Destino | Agência de Viagens </title>
    ...
    <div class="container-fluid mt-3">
        ...
        <header class="row">
            ...
            <div class="col-sm-6 mb-2 text-justify">
                <a href="index.html">
                    <img src="img/Belo Destino3.png"  alt="Logo" height="60px">
            ...
            <div class="col-sm-6 text-center">
                ...
                <p class="small"> Belo Destino  te leva aonde você quer chegar! </p>
    ...
    <footer class="container-fluid bg-light">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6 mb-2 text-right">
                <a href="index.html">
                    <img src="img/Belo Destino3.png" alt="logo" width="150px">
                </a>
            </div>
            ...
            <div class="col-sm-6 text-justify">
                ...
                <h5> Belo Destino </h5>
                <p class="m-0 small">CNPJ 17.143.123/0008-18</p>
                <p class="m-0 small">Rua Pedro Farias, 0010  - HTML CSS BOOTSTRAP</p>
        ...
        <div class="row mt-4 mb-3">
            <div class="col-12 text-center"> &copy 2023 - Belo Destino Agência de Viagens</div>
        </div>
